...
* <b>buffered_messages</b>: Numbered events to be buffered
...
If <em>buffered_messages</em> is greater than <em>0</em>, the last stored data is sent to the client upon connection.
